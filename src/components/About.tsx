          ...
          <div className="lg:col-span-7 flex flex-col justify-center">
            ...
            >
              ...
              <p className="text-base sm:text-lg text-charcoal leading-relaxed mb-6">
                At Cluster Outdoor Solutions, we believe that Kiwis deserve spaces that blur the boundaries between indoors and outdoors, regardless of the season. From coastal Taranaki winds to variable Whanganui weather, our structures are engineered to endure.
              </p>
