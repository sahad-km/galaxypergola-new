...
export const productsData: ProductItem[] = [
  {
    ...
    overviewTitle: "Deluxe Louvre: Your Key to Perfect Outdoor Living",
    overviewDescription: "Your outdoor space should follow your lead. With our rotatable louvre roof, you control sun, shade, airflow, or rain protection in seconds. Featuring IP67 motorised blade control, rain sensor auto-closing, and dual-tone LED lighting.",
